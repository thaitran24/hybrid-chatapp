            ...
            <section styles="background-color: #eee;">
                <div className="container py-5">
                    ...
                    <div className="">
                        ...
                        <div className="card-body" data-mdb-perfect-scrollbar="true" styles="position: relative; height: 400px">

                            <div className="d-flex flex-row justify-content-start">
                            {/* <img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava3-bg.webp"
                                alt="avatar 1" styles="width: 45px; height: 100%;"/> */}
                            <div>
                                <p className="small p-2 ms-3 mb-1 rounded-3" styles="background-color: #f5f6f7;">Hi</p>
                                <p className="small p-2 ms-3 mb-1 rounded-3" styles="background-color: #f5f6f7;">How are you ...???
                                </p>
                                <p className="small p-2 ms-3 mb-1 rounded-3" styles="background-color: #f5f6f7;">What are you doing
                            ...
                            <p className="text-center mx-3 mb-0" styles="color: #a2aab7;">Today</p>
                            </div>
                            ...
                            {/* <img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava3-bg.webp"
                                alt="avatar 1" styles="width: 45px; height: 100%;"/> */}
                            <div>
                                <p className="small p-2 ms-3 mb-1 rounded-3" styles="background-color: #f5f6f7;">Okay</p>
                                <p className="small p-2 ms-3 mb-1 rounded-3" styles="background-color: #f5f6f7;">We will go on
                                Sunday?</p>
                            ...
                            {/* <img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava3-bg.webp"
                                alt="avatar 1" styles="width: 45px; height: 100%;"/> */}
                            <div>
                                <p className="small p-2 ms-3 mb-1 rounded-3" styles="background-color: #f5f6f7;">Okay i will meet
                                you on
                                Sandon Square</p>
                            ...
                            {/* <img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava3-bg.webp"
                                alt="avatar 1" styles="width: 45px; height: 100%;"/> */}
                            <div>
                                <p className="small p-2 ms-3 mb-1 rounded-3" styles="background-color: #f5f6f7;">Sorry I don't
                                have. i
                                changed my phone.</p>
                        ...
                        <div className="card-footer text-muted d-flex justify-content-start align-items-center p-3">
                            {/* <img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava3-bg.webp"
                            alt="avatar 3" styles="width: 40px; height: 100%;"/> */}
